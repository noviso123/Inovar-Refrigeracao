  ...
  const getMenuItems = () => {
    ...
    if (user.cargo === 'tecnico') {
      return [
        ...
        { id: '/minha-assinatura', label: 'Minha Assinatura', icon: CreditCard, section: 'conta' },
        { id: '/configuracoes', label: 'Configurações', icon: Settings, section: 'conta' }
      ];
    }

    // Menu específico para SuperAdmin - APENAS Administração
    if (user.cargo === 'super_admin') {
      return [
        ...
        { id: '/admin/financeiro', label: 'Financeiro (Admin)', icon: BarChart2, section: 'admin' },
        { id: '/admin/notas-fiscais', label: 'Emissão de Notas', icon: FileText, section: 'admin' },
        { id: '/admin/configuracoes', label: 'Configurações (Global)', icon: Settings, section: 'admin' },
        { id: '/admin/empresas', label: 'Gestão de Empresas', icon: Building, section: 'admin' },
        { id: '/admin/usuarios', label: 'Gestão de Usuários', icon: UserIcon, section: 'admin' },
        { id: '/admin/planos', label: 'Planos', icon: Package, section: 'admin' },
        { id: '/admin/assinaturas', label: 'Assinaturas', icon: CreditCard, section: 'admin' }
      ];
    }

    // Menu para Prestador de Serviços - TODAS as telas operacionais
    return [
      { id: '/', label: 'Painel', icon: Home, section: 'geral' },
      { id: '/empresario/solicitacoes', label: 'Gestão de Serviços', icon: Briefcase, section: 'gestao' },
      ...
      { id: '/empresario/qrcode', label: 'Gerador QR Code', icon: QrCode, section: 'gestao' },
      { id: '/empresario/configuracoes', label: 'Configurações', icon: Settings, section: 'gestao' },
      { id: '/empresario/tecnicos', label: 'Técnicos', icon: UserIcon, section: 'gestao' },
      { id: '/minha-assinatura', label: 'Minha Assinatura', icon: CreditCard, section: 'conta' }
    ];
  };
